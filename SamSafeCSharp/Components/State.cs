namespace SamSafeCSharp.Components
{
    public class State
    {
        ...
        public void init(string render, View view, string display = null, string intents = null)
        {
            if(render != null)
            {
                this.view = view;
        ...
        // control state
        public string[] Representation(Model model, string next)
        {
        ...
        public void Render(Model model, string next)
        {
